              ...
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      <a href="<?= base_url('admin/tempatwisata/') . $ty['kode']; ?>" class="btn btn-sm btn-primary">Lihat</a>
                      <a href="javascript:void(0)" onclick="coba('<?= $ty['id'] ?>')" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#Modal">Edit</a>
                      <a href="<?= base_url('Admin/hapusPaket/' . $ty['id']); ?>" class="btn btn-sm btn-danger">Hapus</a>
                    </p>
                  </div>
                </div>
              </div>
