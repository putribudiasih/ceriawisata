    ...
    <div class="row">
        <div class="col-lg">
          ...
          <?php endif; ?>
            ...
            <a href="" class="btn btn-primary mb-4" data-toggle="modal" data-target="#newSubMenuModal">Tambah Submenu Baru</a>
          ...
          <td><?= $sm['is_active']; ?></td>
				  <td>
					<a href="<?= base_url('Admin/hapusSubmenu/' . $sm['id']); ?>" class="badge badge-danger"><i class="fas fa-trash"></i></a>
				  </td>
				</tr>
				<?php $i++; ?>
				<?php endforeach; ?>
