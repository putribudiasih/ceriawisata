    ...
    <div class="col-md-6 mb-md-1">
        <form action="<?= base_url('User/inputpesanan'); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="lokasi_berangkat" class="form-control" required="">
                <div class="error"><?= form_error('Lokasi Berangkat', '<small class="text-danger pl-3">', '</small>'); ?></div>
            </div>
            <div class="form-group">
                <label>Jumlah rombongan</label>
                <input type="text" name="jml_pax" class="form-control" required="">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input id="tanggal" type="date" class="form-control" placeholder="tanggal" name="tgl_mulai" autocomplete="off" required="">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input id="tanggal" type="date" class="form-control" placeholder="tanggal" name="tgl_selesai" autocomplete="off" required="">
                </div>
